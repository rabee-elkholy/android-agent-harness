...
> **Raw Prompt URL**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v1.0.62/docs/rollback-prompt.md`
> **Kit Repository**: `https://github.com/rabee-elkholy/android-agent-harness`
> **Kit version**: `v1.0.62` — **SHA-256**: `336c87c906c0edfe672e58872660c2b6a0a9dcd830b880b2014fa8ec4ed4d832` (SHA-256 of every byte after this line; verify first — mismatch = STOP)
