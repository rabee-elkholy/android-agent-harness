...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.5/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.5/docs/rollback-prompt.md
```
