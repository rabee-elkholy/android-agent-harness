...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.14.23/docs/install-or-update-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.14.23/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.14.23/docs/rollback-prompt.md
```
