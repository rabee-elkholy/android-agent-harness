...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.17.1/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.17.1/docs/rollback-prompt.md
```
