...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.2/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.2/docs/rollback-prompt.md
```
