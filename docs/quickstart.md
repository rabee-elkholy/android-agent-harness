...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.11.0/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.11.0/docs/update-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.11.0/docs/rollback-prompt.md
```
