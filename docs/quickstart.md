...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.4/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.4/docs/rollback-prompt.md
```
