...
- **Install & Update**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.20/docs/install-or-update-prompt.md`
- **Diagnostic Doctor**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.20/docs/diagnostic-prompt.md`
- **Rollback**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.20/docs/rollback-prompt.md`
