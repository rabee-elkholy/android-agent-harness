...
- **Install & Update**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.10/docs/install-or-update-prompt.md`
- **Diagnostic Doctor**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.10/docs/diagnostic-prompt.md`
- **Rollback**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.27.10/docs/rollback-prompt.md`
