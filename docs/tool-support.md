...
- **Install & Update**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.15.0/docs/install-or-update-prompt.md`
- **Diagnostic Doctor**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.15.0/docs/diagnostic-prompt.md`
- **Rollback**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.15.0/docs/rollback-prompt.md`
