...
- **Install & Update**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.22/docs/install-or-update-prompt.md`
- **Diagnostic Doctor**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.22/docs/diagnostic-prompt.md`
- **Rollback**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.22/docs/rollback-prompt.md`
