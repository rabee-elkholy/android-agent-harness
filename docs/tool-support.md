...
- **Install**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.6/docs/install-prompt.md`
- **Update**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.6/docs/update-prompt.md`
- **Diagnostic Doctor**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.6/docs/diagnostic-prompt.md`
- **Rollback**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.6/docs/rollback-prompt.md`
