...
> **Raw Prompt URL**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.14/docs/diagnostic-prompt.md`  
> **Kit Repository**: `https://github.com/rabee-elkholy/android-harness-kit.git`
> **Kit version**: `v0.14.14` — **SHA-256**: `66d43f798fe796e679498d459ece2834d0c01cab6f8b8d69f6a6355e1c5d0773` (SHA-256 of every byte after this line; verify first — mismatch = STOP)
