...
> **Raw Prompt URL**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v1.0.20/docs/diagnostic-prompt.md`
> **Kit Repository**: `https://github.com/rabee-elkholy/android-agent-harness`
> **Kit version**: `v1.0.20` — **SHA-256**: `b02b48d15ab51558edb73aba6e8532bb14788f66efce063c5a53c828097a73e8` (SHA-256 of every byte after this line; verify first — mismatch = STOP)
