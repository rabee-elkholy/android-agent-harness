...
> **Raw Prompt URL**: `https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.11/docs/diagnostic-prompt.md`  
> **Kit Repository**: `https://github.com/rabee-elkholy/android-harness-kit.git`
> **Kit version**: `v0.14.11` — **SHA-256**: `94176133ca8e3e65297243bce3b3b98ddc81bc9eb8f33b04a048e5c8727cdf47` (SHA-256 of every byte after this line; verify first — mismatch = STOP)
