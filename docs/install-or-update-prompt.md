...
`<kit-dir>` is `%USERPROFILE%\.android-harness\kit` or `~/.android-harness/kit` at detached `v1.0.48`.

## Phase 2: Kit bootstrap approval
`git clone --depth 1 --branch v1.0.48 --single-branch https://github.com/rabee-elkholy/android-agent-harness.git <staging-dir>`
