...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/install-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/diagnostic-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/update-prompt.md
```
...
https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/rollback-prompt.md
```
...
| :--- | :--- | :--- |
| **Install** | [`docs/install-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/install-prompt.md) | Full guided installation, module discovery, and adapter generation. |
| **Update** | [`docs/update-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/update-prompt.md) | In-place version upgrade preserving project preferences. |
| **Doctor** | [`docs/diagnostic-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/diagnostic-prompt.md) | 12-dimension comprehensive system health diagnostics. |
| **Rollback** | [`docs/rollback-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-harness-kit/v0.14.8/docs/rollback-prompt.md) | Instant restoration from timestamped backups. |
