...
```text
Read https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.25.3/docs/install-or-update-prompt.md and follow all its instructions.
```
...
| :--- | :--- | :--- |
| **Install & Update** | [`docs/install-or-update-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.25.3/docs/install-or-update-prompt.md) | Guided installation, module discovery, adapter generation, and version upgrades. |
| **Doctor** | [`docs/diagnostic-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.25.3/docs/diagnostic-prompt.md) | 12-dimension comprehensive system health diagnostics. |
| **Rollback** | [`docs/rollback-prompt.md`](https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.25.3/docs/rollback-prompt.md) | Instant restoration from timestamped backups. |
