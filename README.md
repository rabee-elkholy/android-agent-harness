...
```text
Read https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v1.0.54/docs/install-or-update-prompt.md and follow all instructions.
```
...
```bash
git clone --depth 1 --branch v1.0.54 --single-branch \
