...
```text
Read https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v1.0.31/docs/install-or-update-prompt.md and follow all instructions.
```
...
git clone --depth 1 --branch v1.0.31 --single-branch https://github.com/rabee-elkholy/android-agent-harness.git ~/.android-harness/kit
