...
Use a strong reasoning model from your AI provider for the setup chat (fast/lightweight models without deep reasoning tend to skip architectural porting steps and leave a broken setup):
