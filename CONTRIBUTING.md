...
1. **Milestone Consolidation**: Do not create fragmented micro-releases for intermediate commits. Consolidate sprint improvements into clean minor/major milestone releases (`v0.1.0`, `v0.2.0`, `v0.3.0`, `v0.4.0`).
