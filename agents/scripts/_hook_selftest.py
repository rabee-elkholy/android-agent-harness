...
ok_semver = parse_semver("v0.1.0") == (0, 1, 0) and parse_semver("0.5.5") > (0, 5, 4) and get_current_version() == "0.5.4"
...
if (repo_root / "CHANGELOG.md").is_file():
    ...
    ok_changelog_milestones = len(changelog_versions) <= 8 and changelog_versions[0] == get_current_version()
