...
def extract_project_facts(repo: Path, *, in_memory_graph: bool = True, cache_dir: Path | None = None) -> dict:
    ...
    has_xml_views = any(not _skip_path(xml_p, repo) for xml_p in repo.glob("**/res/layout/*.xml"))
