...
3. **Atomic Phase Implementation (Iterative Cycle)**:
   ...
   - **Quality Review Gates**: Shift-left pre-audit -> Unified Review Gate (5 standard leaves, or 6 leaves with `test-quality-reviewer-agent` promoted automatically if tests present) with **Silent Review Wait & Quorum Patience**.
