...
2. Report the vulnerability privately via **[GitHub Private Security Advisories](https://github.com/rabee-elkholy/android-harness-kit/security/advisories/new)** or by contacting the maintainer directly at `rabee.elkholy@gmail.com`.
3. Include:
